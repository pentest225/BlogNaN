...
class Article(models.Model):
    ...
    auteur = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='article_auteur')
...
class ResponseCommentaire(models.Model):
    ...
    user = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='user_response_comment')
    message = HTMLField('message', default="null")
    status = models.BooleanField(default=True)
    date_add = models.DateTimeField(auto_now_add=True)
    date_upd = models.DateTimeField(auto_now=True)
...
class Like(models.Model):
    ...
    user = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='user_like')
